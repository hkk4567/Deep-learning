"""
linear_regression_baseline.py - Baseline co dien bo sung: Linear Regression
De tinh ra tham so (he so) cua tung dac trung, phuc vu doc hieu mo hinh.

Chay: python 03_src/scripts/p6_baseline/linear_regression_baseline.py
"""
import json
import numpy as np
import pandas as pd
...
OUT_METRICS = "05_experiments/linear_regression_metrics.json"
OUT_COEFS = "05_experiments/linear_regression_coefficients.csv"
